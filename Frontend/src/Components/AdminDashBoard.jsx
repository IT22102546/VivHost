    ...
    if (activeSection === "dashboard") {
      const fetchData = async () => {
        try {
          ...
          const fetchPromises = [
            fetch("https://api.viwahaa.com/api/admin/profiles"),
            fetch("https://api.viwahaa.com/api/admin/bookings/count"),
            fetch("https://api.viwahaa.com/api/admin/interests/count"),
          ];

          // Only admin users fetch earnings data
          if (isAdmin) {
            fetchPromises.push(fetch("https://api.viwahaa.com/api/admin/earnings"));
          }

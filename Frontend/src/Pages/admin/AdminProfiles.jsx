  ...
  // Fetch profiles data
   useEffect(() => {
    const fetchProfiles = async () => {
      try {
        setLoading(true);
        const response = await fetch("https://api.viwahaa.com/api/admin/profiles", {
          headers: {
...
const handleFileChange = (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.viwahaa.com/api/admin/profiles/${selectedProfile.id}/images`,
        {
          method: "PUT",
          body: formData,
          headers: {
...
const uploadImage = async () => {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        `https://api.viwahaa.com/api/admin/profiles/${selectedProfile.id}/password`,
        {
          method: "PUT",
          headers: {
  ...
  const confirmDelete = async () => {
    try {
      const response = await fetch(
        `https://api.viwahaa.com/api/admin/profiles/${selectedProfile.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
  ...
  const handleStatusChange = async (profileId, newStatus) => {
    try {
      ...
      const response = await fetch(
        `https://api.viwahaa.com/api/admin/profiles/${profileId}/status`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleViewClick = async (profile) => {
    try {
      setLoading(true);
      const response = await fetch(`https://api.viwahaa.com/api/admin/profiles/${profile.id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
        },
      });
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://api.viwahaa.com/api/admin/profiles/${selectedProfile.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,

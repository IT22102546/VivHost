...
function AdminStaff() {
  ...
  useEffect(() => {
    const fetchStaff = async () => {
      try {
        const response = await fetch("https://api.viwahaa.com/api/staff/staff");
        if (!response.ok) {
  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await fetch(
        `https://api.viwahaa.com/api/staff/staff/search?search=${searchKey}`
      );
      if (!response.ok) {
  ...
  const handleAddStaff = async (e) => {
    ...
    try {
      ...
      // Refresh staff list
      const refreshResponse = await fetch("https://api.viwahaa.com/api/staff/staff");
  ...
  const handleEditStaff = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://api.viwahaa.com/api/staff/staff/${selectedStaff.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
